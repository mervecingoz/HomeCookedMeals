...
describe('Service Tests', () => {
  describe('Delivery Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not update a Delivery', async () => {
      ...
      it('should partial update a Delivery', async () => {
      ...
      it('should not partial update a Delivery', async () => {
      ...
      it('should not return a list of Delivery', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Delivery', async () => {
