...
export default class MealEntry extends Vue {
  ...
  public retrieveAllMealEntrys(): void {
  ...
  public prepareRemove(instance: IMealEntry): void {
  ...
  public removeMealEntry(): void {
    this.mealEntryService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A MealEntry is deleted with identifier ' + this.removeId;
